<template>
  ...
  <div class="flex flex-col gap-3 mt-2 max-h-[300px] overflow-y-auto">
    <div v-for="game in games" :key="game.id" class="flex gap-4">
      <img
        v-if="game.cover"
        :src="game.cover"
...
import { getGamesFromIGDB, type ApiSettingsIGDB } from '~/api/external/igb';
